...
export const FEATURED_SLIDES = [
  {
    ...
    song: {
      ...
      duration: 385,
      audioUrl: resolveApiUrl('/api/songs/20/stream'),
      artwork: resolveApiUrl('/api/images/song/20'),
    },
  },
  {
    id: 2,
    ...
    song: {
      ...
      artist: 'Arijit Singh',
      duration: 245,
      audioUrl: resolveApiUrl('/api/songs/25/stream'),
      artwork: resolveApiUrl('/api/images/song/25'),
    },
  },
  {
    id: 3,
    ...
    song: {
      ...
      artwork: resolveApiUrl('/api/images/song/26'),
    },
  },
  {
    id: 4,
...
export const NEW_RELEASES = [
  {
    ...
    image: resolveApiUrl('/api/images/song/25'),
    song: {
      id: '25',
      title: 'Khat',
      artist: 'Arijit Singh',
  ...
  },
  {
    ...
    image: resolveApiUrl('/api/images/song/20'),
    song: {
      id: '20',
      title: 'Nadaan Parinde',
      artist: 'A.R. Rahman / Mohit Chauhan',
  ...
  },
  {
    ...
    image: resolveApiUrl('/api/images/song/26'),
    song: {
      id: '26',
      title: 'Samjhawan',
      artist: 'Arijit Singh / Shreya Ghoshal',
...
export const RECENTLY_PLAYED = [
  {
    ...
    title: 'Khat',
    category: 'Song',
    image: '/api/images/song/25',
    song: {
      id: '25',
      title: 'Khat',
      artist: 'Arijit Singh',
      duration: 245,
      audioUrl: '/api/songs/25/stream',
      artwork: '/api/images/song/25',
    },
  },
  {
    id: 'rp-20',
    title: 'Nadaan Parinde',
    category: 'Song',
    image: '/api/images/song/20',
    song: {
      id: '20',
      title: 'Nadaan Parinde',
      artist: 'A.R. Rahman / Mohit Chauhan',
      duration: 385,
      audioUrl: '/api/songs/20/stream',
      artwork: '/api/images/song/20',
    },
  },
  {
    id: 'rp-26',
